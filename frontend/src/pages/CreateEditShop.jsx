...
function createEditShop() {
    ...
    return (
        <div className='flex flex-col items-center justify-center p-6 min-h-screen relative bg-gradient-to-br from-orange-50 to-white'>
            <div className='absolute top-[20px] left-[20px] z-[10] mb-[10px]'>
                <IoMdArrowRoundBack size={25} className='text-[#ff4d2d] cursor-pointer' onClick={() => navigate("/")} />
            </div>
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        <label className=' block text-sm font-medium text-gray-700 mb-1'>Add Shop Address</label>
                    ...
                    <button className='w-full bg-[#ff4d2d] text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-orange-500 hover:shadow-lg transition-all duration-200 cursor-pointer'>
                        Save
                    </button>
